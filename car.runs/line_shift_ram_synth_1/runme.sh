...
HD_PWD='F:/Study/FPGA/Project/digit_reco6/digit_reco6.runs/line_shift_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log line_shift_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source line_shift_ram.tcl
