...
HD_PWD='F:/Study/FPGA/Project/digit_reco11/digit_reco11.runs/edge_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log edge_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source edge_buffer.tcl
