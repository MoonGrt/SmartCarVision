...
HD_PWD='F:/Study/FPGA/Project/car/car.runs/img_bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log img_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source img_bit.tcl
