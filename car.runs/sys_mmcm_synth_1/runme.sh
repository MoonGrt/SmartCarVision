...
HD_PWD='F:/Study/FPGA/Project/digit_reco7/digit_reco7.runs/sys_mmcm_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sys_mmcm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sys_mmcm.tcl
