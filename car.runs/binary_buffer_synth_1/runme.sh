...
HD_PWD='F:/Study/FPGA/Project/digit_reco4/digit_reco4.runs/binary_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log binary_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source binary_buffer.tcl
